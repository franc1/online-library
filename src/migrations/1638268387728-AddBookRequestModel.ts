...
export class AddBookRequestModel1638268387728 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "book_request" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "request_date" TIMESTAMP WITH TIME ZONE NOT NULL, "request_status" "public"."book_request_request_status_enum" NOT NULL DEFAULT 'requested', "request_resolved_date" TIMESTAMP WITH TIME ZONE, "back_request_date" TIMESTAMP WITH TIME ZONE, "back_request_status" "public"."book_request_back_request_status_enum", "back_request_resolved_date" TIMESTAMP WITH TIME ZONE, "student_id" uuid NOT NULL, "book_id" uuid NOT NULL, "request_resolved_by" uuid, "back_request_resolved_by" uuid, CONSTRAINT "PK_b858047bddd5d757cd3bd2c4dcd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
