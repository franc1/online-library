...
export class AddBookRequestModel1638268387728 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."book_request_return_request_status_enum" AS ENUM('requested', 'accepted', 'rejected')`,
    );
    await queryRunner.query(
      `CREATE TABLE "book_request" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "id" SERIAL NOT NULL, "request_date" TIMESTAMP WITH TIME ZONE NOT NULL, "request_status" "public"."book_request_request_status_enum" NOT NULL DEFAULT 'requested', "request_resolved_date" TIMESTAMP WITH TIME ZONE, "return_request_date" TIMESTAMP WITH TIME ZONE, "return_request_status" "public"."book_request_return_request_status_enum", "return_request_resolved_date" TIMESTAMP WITH TIME ZONE, "student_id" INTEGER NOT NULL, "book_id" INTEGER NOT NULL, "request_resolved_by" INTEGER, "return_request_resolved_by" INTEGER, CONSTRAINT "PK_b858047bddd5d757cd3bd2c4dcd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "book_request" ADD CONSTRAINT "FK_420cd784e5c7b1bd322d7d77895" FOREIGN KEY ("return_request_resolved_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "book_request" DROP CONSTRAINT "FK_420cd784e5c7b1bd322d7d77895"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."book_request_return_request_status_enum"`,
    );
    await queryRunner.query(
